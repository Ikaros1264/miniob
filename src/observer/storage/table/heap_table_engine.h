...
public:
  ...
  RC update_index(const Record &old_record, const Record &new_record) override;
  ...
  RC create_index(Trx *trx, bool unique, const FieldMeta *field_meta, const char *index_name) override;
